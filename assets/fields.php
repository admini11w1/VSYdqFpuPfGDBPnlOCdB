...
<p>This is the text displayed for the drag & drop area used for multiple files upload fields type.	In case you disabled the Drag & Drop feature through the Options menu, this text will be used for the <i>Add files</i> button</p>',
		...
		array(
			...
			'label' => 'Crop & Upload button (single file)',
			'name' => 'wcuf_crop_and_upload_button',
			'aria-label' => '',
			'type' => 'text',
			'instructions' => 'This is the text used for the <strong>Crop & Upload</strong> button used crop the image file and upload it.',
			'required' => 1,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '25',
		...
		array(
			...
			'label' => 'Crop & Save button (multiple files)',
...
acf_add_local_field_group(array(
	...
	'fields' => array(
		array(
			...
			'aria-label' => '',
			'type' => 'text',
			'instructions' => 'This is the subject used for the notification email sent to the admin after an user has submitted a ticket. You can use the special {ticket_id} to display the ticket id, <strong>{subject}</strong> to display the ticket subject.',
			'required' => 1,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
...
Reply by clicking on the following link: {admin_ticket_page}',
		...
		array(
			...
			'aria-label' => '',
			'type' => 'text',
			'instructions' => 'This is the subject used for the notification email sent to the admin after an user has replied to a ticket. You can use the special {ticket_id} to display the ticket id, <strong>{subject}</strong> to display the ticket subject.',
			'required' => 1,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
...
Reply by clicking on the following link: {admin_ticket_page}',
		...
		array(
			...
			'aria-label' => '',
			'type' => 'text',
			'instructions' => 'This is the subject used for the notification email sent to the user to whom has been assigned the ticket. You can use the special {ticket_id} to display the ticket id, <strong>{subject}</strong> to display the ticket subject.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
